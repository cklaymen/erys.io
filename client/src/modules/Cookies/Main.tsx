  ...
  return (
    <Section>
      ...
      <Trans i18nKey={TranslationKey.COOKIES_POLICY_DESCRIPTION}>
        <P>W celach dostosowania strony do potrzeb użytkowników oraz gromadzenia statystyk witryna ta wykorzystuje pliki cookies. Pliki te nie zawierają żadnych danych osobowych, a informacje w nich zawarte wykorzystywane są do:</P><ul><li>Zbierania statystyk odnośnie użytkowników odwiedzających witrynę z wykorzystaniem narzędzi Google Analytics - szczegóły dotyczące działania znajdują się pod adresem <Link href="https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage">https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage</Link>,</li><li>Obserwowania aktywności odwiedzających z wykorzystaniem narzędzi Hotjar do tworzenia tzw. map cieplnych, które odwzorowują np.najczęściej klikane elementy - szczegóły dotyczące działania znajdują się pod adresem <Link href="https://help.hotjar.com/hc/en-us/articles/115011789248-Hotjar-Cookies">https://help.hotjar.com/hc/en-us/articles/115011789248-Hotjar-Cookies</Link>,</li><li>Dopasowania zawartości strony do preferencji użytkownika poprzez zapamiętanie wybranych ustawień.</li></ul><P>Użytkownik w każdej chwili może zmienić ustawienia przeglądarki internetowej w celu włączenia lub wyłączenia obsługi wspomnianych plików. Instrukcje dla poszczególnych przeglądarek znajdują się pod wymienionymi adresami:</P><ul><li>Google Chrome - <Link href="https://support.google.com/chrome/answer/95647?hl=pl">https://support.google.com/chrome/answer/95647?hl=pl</Link></li><li>Mozilla Firefox - <Link href="https://support.mozilla.org/pl/kb/ciasteczka">https://support.mozilla.org/pl/kb/ciasteczka</Link></li><li>Internet Explorer - <Link href="https://support.microsoft.com/pl-pl/help/17442/windows-internet-explorer-delete-manage-cookies">https://support.microsoft.com/pl-pl/help/17442/windows-internet-explorer-delete-manage-cookies</Link></li><li>Safari - <Link href="https://support.apple.com/pl-pl/guide/safari/sfri11471/mac">https://support.apple.com/pl-pl/guide/safari/sfri11471/mac</Link></li></ul>
      </Trans>
    </Section>
  );
};
